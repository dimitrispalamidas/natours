...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHBhbGFtaWRhcyIsImEiOiJjbHA2cjJibm8xenh0MmpubHQwM29rN2oxIn0.ctYPbZj_vemtRZGjPfBtKA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/dpalamidas/clp6rpmu101m701pmard9f96s',
    scrollZoom: false
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51OFvlJIBhcVLT8c9NyNsDXG5QAztkXfRcqcKR2LJ45opN2p52gQylHzqGxmV8mLbigewHwkPsbGuo3Snsn4Ay26h00YQDDb0nD');
          _context.prev = 1;
          _context.next = 4;
